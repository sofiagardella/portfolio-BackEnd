...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUsuario loginUsuario, BindingResult bindingResult, UserDetails userDetails, UserDetails UserDetails){
        if(bindingResult.hasErrors())
